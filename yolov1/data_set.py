...
DATASET_PATH = 'D:/Codefield/py/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/'  # 数据集文件夹
...
class VOC2012(Dataset):
    def __init__(self, is_train=True, is_aug=True):
        ...
        self.labelpath = "D:/Codefield/py/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/labels/"  # 图像对应的label文件(.txt文件)的路径
        self.is_aug = is_aug
